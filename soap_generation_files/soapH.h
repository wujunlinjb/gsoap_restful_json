...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize_ns__test(soap, p), 0) || soap_put_ns__test(soap, p, "ns:test", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize_ns__test(soap, p), 0) || soap_put_ns__test(soap, p, "ns:test", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
{
	if (soap_read_ns__test(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
